...
SOPCINFO_FILE := C:/Users/gteho/Repositories/EMSYS-LAB/nios/quadrature_nios_pwm.sopcinfo
...
# Design Name 
# setting SOPC_NAME is quadrature_nios_pwm
SOPC_NAME := quadrature_nios_pwm
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x22850
SOPC_SYSID_FLAG += --sidp=0x22850
ELF_PATCH_FLAG  += --sidp 0x22850

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1623410981
SOPC_SYSID_FLAG += --timestamp=1623410981
ELF_PATCH_FLAG  += --timestamp 1623410981
