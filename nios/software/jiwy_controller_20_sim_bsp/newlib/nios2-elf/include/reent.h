...
extern int _close_r _PARAMS ((struct _reent *, int));  /* IntelSpecific */
extern int _execve_r _PARAMS ((struct _reent *, const char *, char *const *, char *const *));  /* IntelSpecific */
extern int _fcntl_r _PARAMS ((struct _reent *, int, int, int));  /* IntelSpecific */
extern int _fork_r _PARAMS ((struct _reent *));  /* IntelSpecific */
extern int _fstat_r _PARAMS ((struct _reent *, int, struct stat *));  /* IntelSpecific */
extern int _getpid_r _PARAMS ((struct _reent *));  /* IntelSpecific */
extern int _isatty_r _PARAMS ((struct _reent *, int));  /* IntelSpecific */
extern int _kill_r _PARAMS ((struct _reent *, int, int));  /* IntelSpecific */
extern int _link_r _PARAMS ((struct _reent *, const char *, const char *));  /* IntelSpecific */
extern _off_t _lseek_r _PARAMS ((struct _reent *, int, _off_t, int));  /* IntelSpecific */
extern int _mkdir_r _PARAMS ((struct _reent *, const char *, int));  /* IntelSpecific */
extern int _open_r _PARAMS ((struct _reent *, const char *, int, int));  /* IntelSpecific */
extern _ssize_t _read_r _PARAMS ((struct _reent *, int, void *, size_t));  /* IntelSpecific */
extern int _rename_r _PARAMS ((struct _reent *, const char *, const char *));  /* IntelSpecific */
extern void *_sbrk_r _PARAMS ((struct _reent *, ptrdiff_t));  /* IntelSpecific */
extern int _stat_r _PARAMS ((struct _reent *, const char *, struct stat *));  /* IntelSpecific */
extern _CLOCK_T_ _times_r _PARAMS ((struct _reent *, struct tms *));  /* IntelSpecific */
extern int _unlink_r _PARAMS ((struct _reent *, const char *));  /* IntelSpecific */
extern int _wait_r _PARAMS ((struct _reent *, int *));  /* IntelSpecific */
extern _ssize_t _write_r _PARAMS ((struct _reent *, int, const void *, size_t));  /* IntelSpecific */

/* This one is not guaranteed to be available on all targets.  */
extern int _gettimeofday_r _PARAMS ((struct _reent *, struct timeval *__tp, void *__tzp));  /* IntelSpecific */
...
extern _off64_t _lseek64_r _PARAMS ((struct _reent *, int, _off64_t, int));  /* IntelSpecific */
extern int _fstat64_r _PARAMS ((struct _reent *, int, struct stat64 *));  /* IntelSpecific */
extern int _open64_r _PARAMS ((struct _reent *, const char *, int, int));  /* IntelSpecific */
extern int _stat64_r _PARAMS ((struct _reent *, const char *, struct stat64 *));  /* IntelSpecific */
