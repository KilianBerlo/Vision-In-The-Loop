...
#ifndef WANT_SMALL_STDIO /* INTEL SMALL STDIO */    /* IntelSpecific */
# define _REENT_SMALL_CHECK_INIT(ptr)		\
  ...
  while (0)
#else                                               /* IntelSpecific */
# define _REENT_SMALL_CHECK_INIT(ptr) /* nothing */ /* IntelSpecific */
#endif                                              /* IntelSpecific */
#else
# define _REENT_SMALL_CHECK_INIT(ptr) /* nothing */ /* IntelSpecific */
#endif
...
#define _REENT_INIT(var) \
  { 0, (__FILE *)&var.__sf_fake[0], (__FILE *)&var.__sf_fake[1], \
    (__FILE *)&var.__sf_fake[2], \
    _NULL, NULL, 0, 0, _NULL, _NULL, _NULL, _NULL, _NULL, \
    _NULL, \
    {_NULL, 0, {_NULL}, _NULL}, \
